...
export const fr: Translations = {
  ...
  directory: {
    ...
    description: 'Parcourez les clubs et associations en {country}. Filtrez par canton et type d\'activité pour trouver votre communauté.',
    filterCanton: 'Canton',
    ...
    noResultsHint: 'Essayez un autre canton ou type d\'activité',
