...
export const en: Translations = {
  ...
  admin: {
    ...
    clubs: {
      ...
      read: 'Read',
      unread: 'Unread',
      messagePlaceholder: 'Write a message to the club admin…',
      reasonPlaceholder: 'Explain why the club page is being taken offline…',
      sendMessageDescription: 'Send a message to the admin of {clubName}. They will receive it by email and in their dashboard.',
      liftOfflineDescription: 'The club page will become visible again if it was previously published.',
    ...
    admin: {
      ...
      clubProfile: {
        ...
        validation: {
          ...
          contactPhoneMaxLength: 'Phone number must be 20 characters or less.',
          contactAddressMaxLength: 'Address must be 500 characters or less.',
          externalWebsiteUrlInvalid: 'Please enter a valid URL.',
        },
        logo: {
