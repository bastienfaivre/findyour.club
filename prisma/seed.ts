...
async function main() {
  ...
  const clubValais = await prisma.club.upsert({
    ...
    create: {
      ...
      description: 'Welcome to Ski Club Valais — your home for alpine skiing in the heart of the Valais region.',
      accentColor: 'blue',
      defaultLanguage: 'fr',
  ...
  const clubLausanne = await prisma.club.upsert({
    ...
    create: {
      ...
      description: 'Welcome to Football Club Lausanne — passion, teamwork, and community on the pitch.',
      accentColor: 'green',
      defaultLanguage: 'fr',
      storageUsedBytes: BigInt(0),
  ...
  const clubZurich = await prisma.club.upsert({
    ...
    create: {
      ...
      description: 'Willkommen beim Bergclub Zürich — Bergsteigen, Klettern und Wandern in und um Zürich.',
      accentColor: 'violet',
      defaultLanguage: 'de',
      storageUsedBytes: BigInt(0),
      storageLimitBytes: BigInt(5368709120),
